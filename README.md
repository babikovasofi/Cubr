...
Cubr — веб-платформа дуэлей по спидкубингу, где судьёй выступает компьютерное зрение в браузере.
...
```
cd existing_repo
git remote add origin https://hub.mos.ru/babikova.sofiya/cubr.git
git branch -M main
...
- [ ] [Настройте интеграцию](https://hub.mos.ru/babikova.sofiya/cubr/-/settings/integrations)
