...
export const EN: Record<string, string> = {
  ...
  Просто: "Simple",
  Профи: "Pro",
  "Что тренируем": "What to drill",
  "Все PLL": "All PLL",
  "Все OLL": "All OLL",
  "Всё вместе": "Both sets",
  "Нужны отдельные случаи, группы или тренировка с любым хватом — вкладка «Профи».":
    "Individual cases, groups and any-grip practice live in the Pro view.",
